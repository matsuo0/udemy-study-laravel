                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <select name="age">
                                    ...
                                    <option value="1" @if($contact->age == 1) checked @endif>〜19歳</option>
                                    <option value="2" @if($contact->age == 2) checked @endif>20歳〜29歳</option>
                                    <option value="3" @if($contact->age == 3) checked @endif>30歳〜49歳</option>
                                    <option value="4" @if($contact->age == 4) checked @endif>40歳〜49歳</option>
                                    <option value="5" @if($contact->age == 5) checked @endif>50歳〜59歳</option>
                                    <option value="6" @if($contact->age == 6) checked @endif>60歳〜</option>
                                </select>
                                </div>
                              </div>
