                            ...
                            <div class="flex flex-wrap -m-2">
                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <input type="radio" name="gender" value="0" {{ old('gender') == 0 ? 'checked' : ''}}>男性</input>
                                  <input type="radio" name="gender" value="1" {{ old('gender') == 1 ? 'checked' : ''}}>女性</input>
                                </div>
                              </div>
                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <select name="age">
                                    ...
                                    <option value="3" {{ old('age') == 3 ? 'selected' : ''}}>30歳〜49歳</option>
